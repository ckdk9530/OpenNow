...
- No StoreKit configuration is wired into the shared schemes.
...
## Submission Notes
- The app is a read-only Markdown reader with no in-app purchases, subscriptions, or paid feature unlocks.
